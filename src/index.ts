...
import { publicRoutes, api, adminUi, debug, cdp, whatsapp } from './routes';
...
// Mount WhatsApp webhook routes (public - Meta needs to reach these)
// Uses verify token for webhook validation, not CF Access
